...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return GiphysIndex; });
...
function (_React$Component) {
  ...
  function GiphysIndex(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(GiphysIndex).call(this, props));
    _this.state = {
      searchTerm: ""
    };
  ...
  _createClass(GiphysIndex, [{
    ...
    value: function handleSubmit(e) {
      ...
      e.preventDefault();
      this.props.fetchSearchGiphys(this.state).then(function () {
        _this2.setState({
          body: "",
          title: ""
        });
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    method: 'GET',
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=RIS82samn9INm0DmYk55vcnPtg1zRCee&limit=2")
  });
};
